...
const rangosSimulacion = {
  graficaPresionBarra: { min: 140, max: 160 },
  graficaRadiacionBarra: { min: 10, max: 500 },
  graficaTemperaturaBarra: { min: 290, max: 340 },
  graficaProduccionBarra: { min: 0, max: 1000 },
  graficaFlujoNeutronesBarra: { min: 1e12, max: 1e14 },
  graficaNivelAguaBarra: { min: 4, max: 6 },
  graficaExposicionPersonalBarra: { min: 100, max: 500 },
  graficaAlarmasBarra: { min: 0, max: 100 },
  graficaTiempoOperacionBarra: { min: 0, max: 24 },
  graficaConcentracionGasesBarra: { min: 0, max: 1000 },
};
